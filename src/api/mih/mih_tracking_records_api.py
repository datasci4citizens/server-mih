...
from schema.mih.schema_mih import TrackingRecords
from schema.mih.schema_mih import TrackingRecordsPublic
...
@mih_tracking_records_router.patch(BASE_URL_TRACKING_RECORDS + "{tracking_record_id}", response_model=TrackingRecordsPublic)
...
@mih_tracking_records_router.get(BASE_URL_TRACKING_RECORDS + "{tracking_record_id}", response_model=TrackingRecordsPublic)
...
@mih_tracking_records_router.delete(BASE_URL_TRACKING_RECORDS + "{tracking_record_id}")
